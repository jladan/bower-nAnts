...
var Size = (function () {
    ...
    Size.prototype.copy = function () { return new Size(this.m, this.n); };
    return Size;
}());
exports.Size = Size;
/** Matrix object
...
var Matrix = (function () {
     ...
     */
    Matrix.prototype.utSolve = function (b) {
     ...
     */
    Matrix.prototype.ltSolve = function (b) {
        if (this.size.m != this.size.n)
            throw new Error('Matrix must be square');
        if (this.size.n != b.size.m)
            throw new Error('Number of rows in the matrices must agree');
     ...
     */
    Matrix.prototype.grabL = function () {
        var L = this.copy();
        var N = L.size.m;
        var i, j;
        for (i = 0; i < N; i++) {
     ...
     */
    Matrix.prototype.grabU = function () {
        var U = this.copy();
        var N = U.size.m;
        var i, j;
        for (i = 0; i < N; i++) {
